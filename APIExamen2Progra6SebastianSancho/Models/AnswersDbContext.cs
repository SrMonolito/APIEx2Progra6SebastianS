...
public partial class AnswersDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AskStatusId).HasName("PK__AskStatu__0329362C2EEEF8FD");
        ...
        {
            entity.HasKey(e => e.CountryId).HasName("PK__Country__10D160BFEE239250");
        ...
        {
            entity.HasKey(e => e.Idconfig).HasName("PK__General__3E2AEF2A7AF3DF86");
        ...
        {
            entity.HasKey(e => e.LikeId).HasName("PK__Like__A2922CF4EEC98F4D");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__User__1788CCAC6664EEB5");
        ...
        {
            entity.HasKey(e => e.UserRoleId).HasName("PK__UserRole__3D978A55B0C69BDE");
        ...
        {
            entity.HasKey(e => e.UserStatusId).HasName("PK__UserStat__A33F541A36298EBC");
